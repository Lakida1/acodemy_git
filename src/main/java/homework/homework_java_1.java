...
//boolean
        ...
        System.out.println("variables: " + isSummer + " " + isWinter + " " + isAccepted + " " + isConfirmed + " " + isConnect + " " + isPaid + " " + isWoman + " " + isMen + " " + isSelected + " " + isInList + '\n');
//Examples
        ...
        System.out.printf("%s - %s is %s which means that all %s must first be declared before they can be used.  %n", stringJava, stringLanguage, stringLanguageType, stringVariables);
        System.out.printf("The value of PI is: %f%n", numberPi);
        System.out.printf("The value of PI with tree decimals after float is: %.3f%n", doubleNumberPi);
        System.out.printf("example -32768-32767 without minus: %+d%n", exampleAdditionSecond);
